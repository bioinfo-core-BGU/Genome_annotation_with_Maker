...
## Maker Round 2
We will now re-run Maker with the newly trained gene predictors. We again build new maker configuration files and populate the appropriate values in maker_opts.ctl

```
est_gff=02.Maker_Round1/Maker_Round1_model_est2genome.gff
protein_gff=02.Maker_Round1/Maker_Round1_model_protein2genome.gff
rm_gff=01.RepeatMasker/RepeatMasker.maker.output/RepeatMasker_model_repeatmasker.gff
snaphmm=04.Snap_Round1/Maker_Round1_zff_train_snap.hmm
augustus_species=macrobrachium_rosenbergii_r1
est2genome=0
protein2genome=0
```
...
maker \
	-g ~/00.Files/Genome.fasta \
	-base "Maker_Round2" \
	~/06.Maker_Round2/maker_opts.ctl \
	~/06.Maker_Round2/maker_bopts.ctl \
	~/06.Maker_Round2/maker_exe.ctl
```
...
fasta_merge \
	-o Maker_Round2 \
	-d ~/06.Maker_Round2/Maker_Round2.maker.output/Maker_Round2_master_datastore_index.log

gff3_merge \
	-n \
	-s \
	-d ~/06.Maker_Round2/Maker_Round2.maker.output/Maker_Round2_master_datastore_index.log \
	> ~/06.Maker_Round2/Maker_Round2_model_all.gff

awk '{ if ($2 == "maker") print $0 }' ~/06.Maker_Round2/Maker_Round2_model_all.gff \
	> ~/06.Maker_Round2/Maker_Round2_model_mRNA.gff

less ~/06.Maker_Round2/Maker_Round2_model_all.gff | \
	awk '$3=="mRNA"' | \
	grep "mRNA-1" | \
	awk '{print $5-$4}' \
	> ~/06.Maker_Round2/Maker_Round2_mRNA_stats.txt
...
perl ~/00.Scripts/AED_cdf_generator.pl \
	-b 0.025 \
	~/06.Maker_Round2/Maker_Round2_model_all.gff \
	> ~/06.Maker_Round2/Maker_Round2_AED_dist.txt
```